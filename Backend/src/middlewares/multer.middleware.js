...
const storage =  multer.memoryStorage() // memoryStorage is used to store the file in memory as a buffer. It is useful when you want to process the file immediately after uploading it, like uploading it to a cloud service.
